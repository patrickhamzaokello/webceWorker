        ...
        <div class="elements">
            <div class="activities">
                ...
                <div class="orderfilter">
                    ...
                    <a href="appointments">
                        <div class="filterorder filter_active">New <span
                                    class="noti circle"><?= $total_new_appointment_stat ?></span></div>
                    </a>


                    <a href="appointments_approved.php">
                        <div class="filterorder">Approved <span
                                    class="noti circlenotactive"><?= $total_approved_appointment_stat ?></span></div>
                    </a>


                    <a href="appointments_canceled.php">
                        <div class="filterorder">Completed <span
                                    class="noti circlenotactive"><?= $total_cancel_appointment_stat ?></span></div>
                    </a>
                            ...
                            foreach ($appoint_new as $row) :
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card__actions">
                                        <a href="appointmentdetail.php?id=<?= $order->getId() ?>"
